...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    #print(group_by_first([[find_closest(restaurant_location(r), centroids), restaurant_name(r)] for r in restaurants]))
    centroid_restaraunt_pairs = [[find_closest(restaurant_location(r), centroids), r] for r in restaurants]
    return group_by_first(centroid_restaraunt_pairs)
    # END Question 4
...
def find_centroid(cluster):
    ...
    average_long = mean([restaurant_location(r)[1] for r in cluster])
